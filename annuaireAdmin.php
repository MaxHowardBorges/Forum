...
<body>
    ...
    <main>
        ...
        <button class="boutonbeau" id="ajouter" onclick="window.location.href = 'ajouterAssociationForm.php'">AJOUTER ASSOCIATION</button>
        <div class="cat">
            <?php
            ...
            ?>
            <div class="categorie" style="--couleur1:#7c7774;--couleur2:#ffffff"><a href="ajouterCategorie.html"><img src="assets/img/addIcon.png" />
